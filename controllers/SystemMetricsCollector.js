...
class SystemMetricsCollector {
        ...
        try {
            ...
            if (this.lastCPUTimes) {
                perCoreData = currentCPUTimes.map((core, i) => {
                    ...
                    const totalDiff = (core.times.user - lastCore.times.user) +
    ...
    async collectMemoryStats() {
        try {
            ...
            const availableMemoryBytes = (kstatStats.availrmem_pages || kstatStats.freemem_pages || 0) * pageSize;
    ...
    async cleanupOldData() {
        ...
        try {
            ...
            // Clean CPU data
            const cpuRetentionDate = new Date(now.getTime() - (retentionConfig.cpu_stats * 24 * 60 * 60 * 1000));
            ...
            // Clean memory data
            const memoryRetentionDate = new Date(now.getTime() - (retentionConfig.memory_stats * 24 * 60 * 60 * 1000));
