 ...
 */
export const syncZoneToDatabase = async (zoneName, statusOverride = null, providedConfig = null) => {
  try {
    ...
    log.monitoring.error('Failed to sync zone to database', { zone_name: zoneName, error: error.message });
    throw error;
  }
};
